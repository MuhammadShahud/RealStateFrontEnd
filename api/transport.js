...
const Transport = {
  HTTP: {
    ...
    getQuizesSet: (token) =>
      axios({
        url: 'https://realestateadvantage.herokuapp.com/api/quiz',
        method: "GET",
        headers: {
          authorization: "Bearer " + token,
        },
    ...
    addFlashcardSet: (data, token) =>
      axios({
        url: "https://realestateadvantage.herokuapp.com/api/set/",
        method: "POST",
        data,
        headers: {
          authorization: "Bearer " + token,
    ...
    getFlashcardSet: (token) =>
      axios({
        url: "https://realestateadvantage.herokuapp.com/api/set?subject=cards",
        method: "GET",
        headers: {
          authorization: "Bearer " + token,
        },
    ...
    getVocabularySet: (token) =>
      axios({
        url: "https://realestateadvantage.herokuapp.com/api/set?subject=vocabulary",
        method: "GET",
        headers: {
          authorization: "Bearer " + token,
        },
    ...
    getFlashcardSetById: (id, token) =>
      axios({
        url: `https://realestateadvantage.herokuapp.com/api/set/${id}`,
        method: "GET",
        headers: {
          authorization: "Bearer " + token,
        },
    ...
    createCards: (data, token) =>
      axios({
        url: "https://realestateadvantage.herokuapp.com/api/card",
        method: "POST",
        data,
        headers: {
          authorization: "Bearer " + token,
    ...
    updateCard: (id, data, token) =>
      axios({
        url: `https://realestateadvantage.herokuapp.com/api/card/${id}`,
        method: "PATCH",
        data,
        headers: {
          authorization: "Bearer " + token,
    ...
    deleteManyCards: (setId, token) =>
      axios({
        url: `https://realestateadvantage.herokuapp.com/api/card?setId=${setId}`,
        method: "DELETE",
        headers: {
          authorization: "Bearer " + token,
        },
    ...
    getCardsBySetId: (id, token) =>
      axios({
        url: `https://realestateadvantage.herokuapp.com/api/card?setId=${id}&limit=500`,
        method: "GET",
        headers: {
          authorization: "Bearer " + token,
        },
    ...
    getQuestions: (subject) =>
      axios({
        url: `https://realestateadvantage.herokuapp.com/api/question?subject=${subject}&limit=500`,
        method: "GET",
      }),

    createQuestion: (data, token) =>
      axios({
        url: "https://realestateadvantage.herokuapp.com/api/question/",
        method: "POST",
        data,
        headers: {
          authorization: "Bearer " + token,
    ...
    deleteQuestion: (id, token) =>
      axios({
        url: `https://realestateadvantage.herokuapp.com/api/question/${id}`,
        method: "DELETE",
        headers: {
          authorization: "Bearer " + token,
        },
    ...
    updateQuestion: (data) =>
      axios({
        url: `https://realestateadvantage.herokuapp.com/api/question/${data.id}`,
        method: "PATCH",
        data,
      }),
    ...
    getQuizzesSetById: (id, token) =>
      axios({
        url: `https://realestateadvantage.herokuapp.com/api/quiz/${id}`,
        method: "GET",
        headers: {
          authorization: "Bearer " + token,
        },
